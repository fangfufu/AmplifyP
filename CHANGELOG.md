...
## [1.13.0](https://github.com/fangfufu/AmplifyP/compare/v1.22.0...v1.13.0) (2026-09-13)
...
* **gui:** add 1D primer designer view ([7c63c93](https://github.com/fangfufu/AmplifyP/commit/7c63c93304c64e86ad0c5c770f65be58876d5a90))
...
* **primer-designer:** add quality_score and best_score ([da1c5ff](https://github.com/fangfufu/AmplifyP/commit/da1c5ff4f8474eeda39afcfc5c2661754cbab995))
...
* **deps:** enable git credentials for dependency autoupdate workflow ([76a9a0b](https://github.com/fangfufu/AmplifyP/commit/76a9a0baa33316abb839589d09ca566819175f13))
...
* remove unnecessary isinstance checks in PrimerDesigner1D ([51ad313](https://github.com/fangfufu/AmplifyP/commit/51ad313cbffdd0be2f5751d2eab76b16e53f2777))
...
* resolve LSP type errors in flet callback signatures ([98bf2d9](https://github.com/fangfufu/AmplifyP/commit/98bf2d95935533dbb54f63432cb124fd13563bb4))
...
* **amplicon:** optimise amplicon generation ([4f30396](https://github.com/fangfufu/AmplifyP/commit/4f30396d86372381d22efdffe41536962f7d1aad))
* **ci:** extract Linux build to script ([532974a](https://github.com/fangfufu/AmplifyP/commit/532974af99ece9c0ef478846e8ac8b18219f6450))
...
* **deps:** define IGNORED_PACKAGES as an empty set ([56ce7bb](https://github.com/fangfufu/AmplifyP/commit/56ce7bb69b3bb9c14ef6aa9d9b9188f63bf6d301))
* **dimer:** consolidate dimer card rendering ([e7f0024](https://github.com/fangfufu/AmplifyP/commit/e7f002430fdaa6ce9dadd468612c36c7ddfd0fec))
* **dimer:** optimise primer dimer calculations ([1c93473](https://github.com/fangfufu/AmplifyP/commit/1c9347397e2372b3f3a4ae980c1098db2899bac0))
* **dna:** optimize DNA and Primer classes ([1f3bdae](https://github.com/fangfufu/AmplifyP/commit/1f3bdaeb04bb8780a09e6d4e675b519d6e773ed4))
* **errors:** add AmplifyPError base class ([298a758](https://github.com/fangfufu/AmplifyP/commit/298a758a52aec8eb670a4e53bd6180f0aee7dbe9))
* **gui:** address PR [#274](https://github.com/fangfufu/AmplifyP/issues/274) review comments ([e876ad4](https://github.com/fangfufu/AmplifyP/commit/e876ad41b50c0fd5fe6e682e58f0668ddf1b05d0))
* **gui:** address review comments on PR [#295](https://github.com/fangfufu/AmplifyP/issues/295) ([0488f12](https://github.com/fangfufu/AmplifyP/commit/0488f12e29c38c8f9503035a8f3686c24d8cdddd))
* **gui:** address review comments on PR 263 ([66e9ccf](https://github.com/fangfufu/AmplifyP/commit/66e9ccf454ea815056b7e2a98b31a1eac7bd92ee))
* **gui:** align template gutter and style ([8d8dfc1](https://github.com/fangfufu/AmplifyP/commit/8d8dfc1f1a2810464b135737fa552a3b1e0b3611))
* **gui:** consolidate focus helper into util ([e8d006e](https://github.com/fangfufu/AmplifyP/commit/e8d006e488e8ffb8841dce47d302283f9fe108dd))
* **gui:** deduplicate git SHA retrieval logic ([5b7ff37](https://github.com/fangfufu/AmplifyP/commit/5b7ff379033bc91d2b31a50b72f6379258ec013d))
...
* **gui:** extract template wrapping helper ([b631cbc](https://github.com/fangfufu/AmplifyP/commit/b631cbcc85e22d9582075a2bbbdfb8dbcc3cf32c))
* **gui:** merge nested if statements in load_last_state ([296f963](https://github.com/fangfufu/AmplifyP/commit/296f963ba3bfbccf5ea50d96ecf30922d5140095))
...
* **gui:** remove redundant exception catches ([432e6d4](https://github.com/fangfufu/AmplifyP/commit/432e6d443463c6d5ada8baabf246904f33dae2d7))
* **gui:** rename designer views to designer_1d ([230963e](https://github.com/fangfufu/AmplifyP/commit/230963e6dd14097b4c844e4424e6ee3171e6409f))
* **gui:** reorder PCR settings tile below Tm tile ([1f5e717](https://github.com/fangfufu/AmplifyP/commit/1f5e717642a7d1c36c30f6374e61bde3b522bacd))
* **gui:** reuse clean_sequence helper for gutter ([d8cee10](https://github.com/fangfufu/AmplifyP/commit/d8cee1049aec29958f53305ee4c169c0dd4e1c94))
* **gui:** scale template input width dynamically ([cc26f9c](https://github.com/fangfufu/AmplifyP/commit/cc26f9cb991a0e7d3066cd0709cfd7c21f70c592))
* **gui:** simplify Designer 1D horizontal drag handler ([835d880](https://github.com/fangfufu/AmplifyP/commit/835d880c446eada063e2f667abef9e46885ef0f9))
* **gui:** simplify header buttons and labels ([d7e207f](https://github.com/fangfufu/AmplifyP/commit/d7e207f40cba12bb6c5961adb0d5588228d40eeb))
* **gui:** simplify line indices and base counting ([f73d5f2](https://github.com/fangfufu/AmplifyP/commit/f73d5f2c3ba9e411dbc383462e008a3e155e0a92))
* **gui:** simplify template input status bar ([e0cbb90](https://github.com/fangfufu/AmplifyP/commit/e0cbb901b9a50259ceb6638e02d442392290c85d))
* **gui:** split 1d primer designer view into components ([eeb96ed](https://github.com/fangfufu/AmplifyP/commit/eeb96ed93581c0b90f06eefb0aa8383127590561))
* **gui:** split GUI into focused sub-packages ([461bbb7](https://github.com/fangfufu/AmplifyP/commit/461bbb7a7ff296011c0680abfc738c9cd64a0cc8))
...
* **gui:** use public colour_deficient_mode in colours.py ([f802eaf](https://github.com/fangfufu/AmplifyP/commit/f802eaffb7db70bdcbfa6fcd1c51f9d19a7b3c71))
* **melting:** improve Tm calculation accuracy ([f0995f1](https://github.com/fangfufu/AmplifyP/commit/f0995f1bf6a4e91e66d8f8f70bcb27369a0e0426))
* merge backup/updates into general ([4263565](https://github.com/fangfufu/AmplifyP/commit/42635656b46f49939fd528d4a0aa90bb6ca05a70))
* merge coverage reports and add CODECOV_TOKEN ([7b711f3](https://github.com/fangfufu/AmplifyP/commit/7b711f37a9fd291fee9410451d70434fa80ace70))
* merge nested if statements in controller.py ([f35cc57](https://github.com/fangfufu/AmplifyP/commit/f35cc572bf8c2869f51e3ef751ead6212c8f4acb))
* **origin:** optimise caching and performance ([3176b02](https://github.com/fangfufu/AmplifyP/commit/3176b02a1936f38bcd114c79008ddff11368c720))
* **origin:** standardise cached score field names ([5d48abe](https://github.com/fangfufu/AmplifyP/commit/5d48abe498deee997b2c10ed084b40c5be2bf578))
* **pcr:** improve caching and container protocols ([bbaa098](https://github.com/fangfufu/AmplifyP/commit/bbaa09819553bdb846ed540ca95a66a6fa1d1278))
* **primer_designer:** return step indices for query methods ([ef06594](https://github.com/fangfufu/AmplifyP/commit/ef06594482173bfe84ea957e6cec88fa76f1fb6d))
* **primer_row:** deduplicate blur and selection handlers ([48eaff4](https://github.com/fangfufu/AmplifyP/commit/48eaff475a5fa8bf7bfdde776882bf412e377089))
* **primer-designer:** simplify PrimerDesigner1D interface ([595ecde](https://github.com/fangfufu/AmplifyP/commit/595ecdebbbf498a80a0585223f7d07d07c8d16a7))
* **primer:** rename primer module to primer_designer ([174999e](https://github.com/fangfufu/AmplifyP/commit/174999e62ad8144e4b37aa0134c60193acf95973))
...
* remove redundant __all__ export ([091589c](https://github.com/fangfufu/AmplifyP/commit/091589cd20e54b3407d8daf8e944a72d71cd0ba4))
* rename build_static.sh to build_web.sh ([a078341](https://github.com/fangfufu/AmplifyP/commit/a078341f48d3870bd1f4951aa3340f0af72629b7))
* rename primer_designer to 1d module ([9970b7f](https://github.com/fangfufu/AmplifyP/commit/9970b7f765d659cf8bbb698e9b65791788ccbd04))
* **repliconf:** extract DirIdx classes to dir_idx ([c655a3b](https://github.com/fangfufu/AmplifyP/commit/c655a3b9c593f6676b57a51d97341ee7501ece8c))
* **repliconf:** optimise search & cache safety ([6306097](https://github.com/fangfufu/AmplifyP/commit/6306097a66446b4d5b92ce4be879b5b1494d473a))
* **settings:** inline BaseScoreTile ([4d40682](https://github.com/fangfufu/AmplifyP/commit/4d4068219ddb31017ee680ae3ab91c662907fb49))
* **settings:** optimize weight lookup tables ([3df7680](https://github.com/fangfufu/AmplifyP/commit/3df7680556cd71ad021b49589a5ce0cb1b708623))
* support ignore_inactive flags in duplicate validation ([c5543d5](https://github.com/fangfufu/AmplifyP/commit/c5543d56e8edad7751fd6041ebd15bf558f9ecfb))
* **tests:** deduplicate gui_state_test ([7107007](https://github.com/fangfufu/AmplifyP/commit/71070079ec45b735bb982683ce67b43408adc729))
* **tests:** move GUI tests to tests/gui ([7bd57f1](https://github.com/fangfufu/AmplifyP/commit/7bd57f1484d96d160cdb8e05a9749fed37b587f0))
